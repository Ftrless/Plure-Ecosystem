...
public class WarpRevokeInvite implements Command<ServerCommandSource> {
    @Override
    ...
    public void exec(CommandContext<ServerCommandSource> context, ServerPlayerEntity senderPlayer,
        ...
        Message notExist = TextUtils.translation("cmd.warp.revoke-invite.error.not-exist", FormatUtils.Colors.ERROR);
        Message notOwner = TextUtils.translation("cmd.warp.revoke-invite.error.not-owner", FormatUtils.Colors.ERROR);
        Message selfInvitation = TextUtils.translation("cmd.warp.revoke-invite.error.self-revoke-invitation", FormatUtils.Colors.ERROR);
        ...
        warpDataManager.deInvitePlayer(warpName, targetPlayer.getUuid());

        PlayerUtils.sendFeedback(context, "cmd.warp.revoke-invite.feedback", warpName);
    }
}
